...
// import { fetchProducts, updatePropertyStatusAdmin } from "../../../../redux/PropertieSlice";
...
//   useEffect(() => {
//     if (!properties.length) dispatch(fetchProducts())
//       .unwrap()
//      .then(() => {
...
//                 <button
//   onClick={() => 
//     dispatch(updatePropertyStatusAdmin({ id: property._id, 
...
//                  <button
//   onClick={() =>
//     dispatch(updatePropertyStatusAdmin({ id: property._id, propertystatus: "removed" }))
//   }
