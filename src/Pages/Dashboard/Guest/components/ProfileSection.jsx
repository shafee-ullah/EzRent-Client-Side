...
import { Shield, CreditCard, ChevronDown, User2 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl p-6 text-white">
          <div className="text-center items-center">
            {
              authUser?.photoURL ? (
                <img src={authUser.photoURL} alt={<User2 className="w-12 h-12 text-gray-400 bg-gray-200 p-2 rounded-full" />} className="w-20 h-20 rounded-full mx-auto mb-4 border-4 border-white/20"></img>
              ) : (<User2 className="w-20 h-20 rounded-full mx-auto mb-4 border-4 border-white/20" />)
            }
