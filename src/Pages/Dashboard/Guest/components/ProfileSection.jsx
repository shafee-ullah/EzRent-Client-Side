          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white">{authUser?.displayName || "Not set"}</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
            ...
            <div className="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm font-medium text-gray-900 dark:text-white capitalize">{user?.role || "Guest"}</p>
              </div>
            </div>
          </div>
        </motion.div>
