...
//       {/* Cards */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12 md:px-14 px-4">
...
//             className="relative group rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-2xl border border-transparent hover:border-green-500 transition-all"
//           >
//             {/* Image */}
...
//                 className="absolute top-3 left-3 bg-green-600 text-white text-sm px-3 py-1 rounded-full shadow-md"
//               >
...
//                   size={20}
//                   className={`${
//                     wishlist.includes(propertie.id) ? "text-red-500" : "text-gray-400"
//                   }`}
//                 />
//               </button>
//             </div>
...
//               <h1 className="text-lg font-semibold text-gray-700">{propertie.title}</h1>

//               {/* Expandable description */}
//               <p className="text-sm text-gray-500">
//                 {expanded === propertie.id
//                   ? propertie.long_description
//                   : `${propertie.long_description.slice(0, 60)}...`}
//                 <button
//                   onClick={() =>
...
//                   whileTap={{ scale: 0.9 }}
//                   className="mt-3 w-full py-2 flex justify-center items-center gap-2 rounded-lg font-bold text-white bg-emerald-500"
//                 >
