                            ...
                            <form onSubmit={handleSubmitFormData}>
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <label className="text-gray-900 dark:text-gray-300 text-sm mb-1">Where to?</label>
                                    ...
                                    {/* Check-in */}
                                    <div className="flex flex-col">
                                        <label className="text-gray-900 dark:text-gray-300 text-sm mb-1">Check-in</label>
                                        <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2">
                                    ...
                                    {/* Check-out */}
                                    <div className="flex flex-col">
                                        <label className="text-gray-900 dark:text-gray-300 text-sm mb-1">Check-out</label>
                                        <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2">
                                            <HiOutlineCalendar className="text-gray-400 mr-2" />
                                            <input
                                                name="check-out"
                                    ...
                                    {/* Guests */}
                                    <div className="flex flex-col">
                                        <label className="text-gray-900 dark:text-gray-300 text-sm mb-1">Guests</label>
                                        <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2">
                                ...
                                <div className="flex justify-center mt-6">
                                    ...
                                    <button type="submit" className="w-full flex items-center md:w-auto  text-green-600 font-semibold border-green-700/20 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800 hover:bg-gray-200 border-2 px-6 py-3 rounded-lg text-center">
