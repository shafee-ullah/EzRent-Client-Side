                    ...
                    <div className="flex gap-4">
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-center gap-4">
                                <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" aria-hidden>
                                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.86 19.86 0 0 1 2.08 4.18 2 2 0 0 1 4 2h3a2 2 0 0 1 2 1.72c.12.94.36 1.86.72 2.72a2 2 0 0 1-.45 2.11L9.91 9.91a16 16 0 0 0 6 6l1.35-1.35a2 2 0 0 1 2.11-.45c.86.36 1.78.6 2.72.72A2 2 0 0 1 22 16.92z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>

                                <a href="tel:+1234567890" className="block leading-tight hover:underline">
                            ...
                            <li className="flex items-center gap-4">
                                ...
                                <a href="endgameprogramm10@gmail.com" className="block leading-tight hover:underline">
                                    <span className="block font-medium">endgameprogramm10@gmail.com</span>
                                </a>
                            </li>
                        </ul>
                    </div>
