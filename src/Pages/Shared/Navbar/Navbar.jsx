            ...
            <div className="navbar w-11/12 mx-auto ">
                ...
                <div className="navbar-end">
                    <div className=' space-x-3 hidden  lg:flex'>
                        <NavLink to={'/wishlist'} className={'flex hover:bg-green-700 rounded-2xl px-3 hover:text-white py-1 items-center gap-2 font-semibold text-sm'}>
                            <Heart /> Wishlist
                        </NavLink>
                        <NavLink to={'/dashboard'} className={'flex hover:bg-green-700 rounded-2xl px-3 hover:text-white py-1 items-center gap-2 font-semibold text-sm'}>
                ...
                <div className="lg:hidden mt-2">
                    <ul className="menu bg-base-400  hover:bg-blue-100  rounded-box shadow p-4 space-y-2">
                        ...
                        <div className='space-y-3'>
                            <NavLink to={'/wishlist'} className={'flex items-center gap-2 font-bold text-sm'}>
                                <Heart /> Wishlist
                            </NavLink>
                            <NavLink to={'/dashboard'} className={'flex items-center gap-2 font-bold text-sm'}>
                                <LayoutDashboard />   Dashboard
                            </NavLink>
                            <button
                                onClick={toggleTheme}
